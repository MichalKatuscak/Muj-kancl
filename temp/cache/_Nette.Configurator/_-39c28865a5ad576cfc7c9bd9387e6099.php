<?php //netteCache[01]000048a:1:{s:4:"time";s:21:"0.19871000 1341402954";}?><?php
// source: /data/web/virtuals/21251/virtual/www/subdom/app/app/config/config.neon production
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/data/web/virtuals/21251/virtual/www/subdom/app/app',
			'wwwDir' => '/data/web/virtuals/21251/virtual/www/subdom/app',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/data/web/virtuals/21251/virtual/www/subdom/app/app/../temp',
			'database' => array(
				'driver' => 'mysql',
				'host' => 'wm18.wedos.net',
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/data/web/virtuals/21251/virtual/www/subdom/app/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/data/web/virtuals/21251/virtual/www/subdom/app/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/data/web/virtuals/21251/virtual/www/subdom/app/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/data/web/virtuals/21251/virtual/www/subdom/app/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
